...
dati aggiornati relativamente alla posizione della specifica tratta come anche informazioni relative agli orari. Il formato in cui AMTAB pubblica i suoi dati sono in GTFS-RT.

\section{Aggiunta di un sito web}

Potrebbe risultare agevole includere un sito web che offra 
