...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.25\textwidth]{Materiale Multimediale/imad-alassiry unsplash-Feb-5-2022.jpg}%
    \hspace{0.05\textwidth}%
    \includegraphics[width=0.35\textwidth]{Materiale Multimediale/max-bender-unsplash-Maggio-11-2020.jpg}
    \caption{Anziana con deambulatore pieghevole \cite{foto_deambulatore_mobile}}
