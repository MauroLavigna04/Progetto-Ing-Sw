...
ossia uno strumento di build utilizzato per automatizzare il processo di compilazione del progetto e nel nostro caso lo utilizziamo per gestire l'implementazione di librerie esterne.
