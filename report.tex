...
gestisce il testing delle applicazioni e le dipendenze tramite Grandle, ossia uno strumento di build utilizzato per automatizzare il processo di compilazione del progetto e nel nostro caso lo utilizziamo per gestire l'implementazione di librerie esterne presenti nel progetto. Inoltre  la particolarità di android è l'integrazioni di  emulatori 
e strumenti di analisi che facilitano lo sviluppo e la manutenzione del software anche dal punto vista grafico e visivo, visualizzando in maniera 
instantanea l'applicativo progettato.
