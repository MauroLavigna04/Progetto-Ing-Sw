...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.45\textwidth]{Materiale Multimediale/Foto/BrailleTouchs-input-surface.jpg}%
    \hspace{0.05\textwidth}
...
Kimap è un'applicazione per dispositivi mobili che, per certi versi, più si avvicina all'applicazione che intendiamo realizzare. E' utile menzionare anche il fatto che Kimap prevede
...
e raccogliere dei punti. Su quest'ultimo punto è necessario soffermarsi, infatti Kimap utilizza elementi di Gamification, che è dimostrato aumentare considerevolmente il coinvolgimento degli utenti\cite{art_7}, anche per applicazioni
che esulano dal mondo della didattica e dell'apprendimento. Come è possibile 


\begin{figure}[h]
    \centering
    \includegraphics[width=0.30\textwidth]{Materiale Multimediale/Foto/Interfaccia Kimap 1.jpeg}%
    \includegraphics[width=0.30\textwidth]{Materiale Multimediale/Foto/Interfaccia Kimap 2.jpeg}%
    \hspace{0.05\textwidth}
