...
\begin{figure}[h]
    \begin{minipage}[t]{0.2\textwidth}
        \includegraphics[width=\textwidth]{schermataInii.jpeg}
...
%\begin{figure}[h]
    \hfill
    \begin{minipage}[t]{0.2\textwidth}
        \includegraphics[width=\textwidth]{registrazione.jpeg}
        \caption{Schermata di registrazione}
        \label{fig:sign in screen}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.2\textwidth}
        \includegraphics[width=\textwidth]{menu.jpeg}
