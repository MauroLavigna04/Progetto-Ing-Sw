...
precedentemente chiarificati, valutare anche l'utilizzo di un dataset geografico più accurato quale GeoPostcodes. L'aspetto cardine a cui faremo riferimento sarà dunque la disponibilità dell'applicazione,
...
Per questo si è ritenuto sufficiente considerare soltante questi due store di applicazioni.

\subsection{Stima dei costi utilizzando OpenStreetMap}

Come chiarificato in precedenza, l'utilizzo di OpenStreetMap non implica costi aggiuntivi relativi ai dati geografici.
