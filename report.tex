...
In alternativa, esistono tecnologie non open source che garantiscono dati geografici più accurati, come ad esempio GeoPostcodes; in seguito verrà effettuata una stima dei costi
nel caso in cui il progetto proposto dovesse implementare GeoPostcodes.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.55\textwidth]{Materiale Multimediale/Foto/Interfaccia_wheelmap.png}%
    \hspace{0.05\textwidth}
...
\section{Valutazioni generali, rischi e stima dei costi}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\textwidth]{Materiale Multimediale/Gantt_foto.png}%
    \hspace{0.05\textwidth}
    \caption{Diagramma di Gantt utilizzato.}
    \label{fig:immagini}
\end{figure}

Uno dei possibili rischi è legato ad una non adeguata accuratezza del dataset di OpenStreetMap in quanto l'applicazione dovrebbe garantire la più alta fedeltà geografica possibile, soprattutto
se gli utenti sono affetti da impedimenti e quindi sensibili a variazioni e inaccuratezze. Per questo si è ritenuto opportuno analizzare delle alternative closed source con il fine di 
ottenere una qualità maggiore anche a fronte di costi maggiori. GeoPostcodes costituisce una di queste alternative.
