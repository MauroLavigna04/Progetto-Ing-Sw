...
dati aggiornati relativamente alla posizione della specifica tratta come anche informazioni relative agli orari. Il formato in cui AMTAB
pubblica i suoi dati sono in GTFS-RT.

\section{Aggiunta di un sito web}

Potrebbe risultare agevole includere un sito web che offra la possibilità di essere 

\section{UX/UI Design}

Gli acronimi UX e UI stanno rispettivamente per User Experience e User Interface. La UX riguarda l'esperienza complessiva vista da parte dell'utente, mentre la UI si riferisce
